<?php 
include('../Model/config/session.view.php');
include('../Model/config/session.expirty.view.php');
    ...
    <body>
            ...
            <div id="header_menu">
                <div class="container">
                    <ul>
                        ...
                        <li class="test" id="Username_a"><a href="logout.php" id = "logoutBtn">Log Out</a></li>
        ...
        <main>
            <div class="container">
                <div class="question">
                    <br />
                    <h2 class="post_text">Good Question</h2>
                    <br />
                    <p class="post_text">
                         Good Description!
                    </p>
                    ...
                    <div class="post_text">
                        ...
                        <input type="hidden" name="tId" class="tId" value="12" /><br />
